...
Original README from the QEMU repo was renamed to QemuReadme.md

New code unique to this repository is placed in the ```/Platforms/PATINA_TIANOCORE_DEV``` directory
